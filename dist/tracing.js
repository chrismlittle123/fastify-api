...
async function resolveOtlpEndpoint() {
...
if (useConsoleExporter) {
    ...
    logProcessors.push(new BatchLogRecordProcessor(new OTLPLogExporter({
...
if (!spanProcessor) {
    console.warn('[tracing] No OTEL_EXPORTER_OTLP_ENDPOINT set. Set OTEL_CONSOLE_EXPORTER=true for local debugging.');
}
